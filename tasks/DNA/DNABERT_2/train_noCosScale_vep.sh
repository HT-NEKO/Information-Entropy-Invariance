...
data_path=/data/run01/scv6872/kwli/infoscale/LRB/variant_effect_pathogenic/vep_pathogenic_coding/500/
lr=3e-5
...
do
    for data in covid
    do
        torchrun --master_port 31000 --nproc_per_node=${num_gpu} train_kyw.py \
